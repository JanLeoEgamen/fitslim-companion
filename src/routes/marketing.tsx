      ...
      <header className="sticky top-0 z-40 border-b bg-background/90 backdrop-blur">
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/home"
              className="rounded-[12px] bg-teal px-4 py-2 text-sm font-semibold text-white transition hover:bg-bright-teal"
            >
      ...
      <main>
          ...
          <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
            <div className="max-w-[680px] text-left">
              ...
              <p className="mt-4 max-w-xl text-lg leading-relaxed text-muted-foreground">
                FitSlim AI™ gives members practical educational support for nutrition, meals,
                movement, hydration, travel, healthy habits, and more.
              </p>
              <div className="mt-7 flex flex-col gap-3 sm:flex-row">
                <Button
                  ...
                  asChild
                >
                  <Link to="/home">START YOUR FREE ASSESSMENT</Link>
                </Button>
                <Button
                  variant="outline"
                  ...
                  asChild
                >
                  <Link to="/home">EXPLORE THE FITSLIM METHOD™</Link>
                </Button>
              </div>
            </div>
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          ...
          <p className="mt-3 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Most people don't struggle because they lack motivation — they struggle because
            questions come up between appointments without a place to go. FitSlim AI gives you a
            friendly place to get educational guidance any time.
          </p>
            ...
            {[
              {
                ...
                text: "Meal ideas, protein tips, restaurant and grocery help.",
              },
              {
                icon: Coffee,
                title: "Built around your day",
                text: "Practical habits you can actually keep.",
              },
              {
                icon: HeartPulse,
                title: "Human-first boundaries",
                text: "Educational support — never a replacement for your provider.",
              },
            ].map((card) => (
              <div
                key={card.title}
              ...
              {[
                {
                  icon: UtensilsCrossed,
                  title: "Healthy meals",
                  text: "Plan balanced plates and protein-forward meals.",
                },
                {
                  icon: UtensilsCrossed,
                  title: "Recipes & groceries",
                  text: "Quick recipes that turn into easy shopping lists.",
                },
                {
                  icon: MessageCircle,
                ...
                },
                {
                  ...
                  text: "Prep questions to discuss with your provider.",
                },
              ].map((card) => (
                <div
                  key={card.title}
                  className="flex items-start gap-3 rounded-[20px] border border-border bg-card p-5 shadow-soft"
                >
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          ...
          <div className="mt-8 grid gap-4 lg:grid-cols-2">
            <div className="rounded-[20px] border border-border bg-card p-6 shadow-soft">
              <div className="flex items-center gap-2">
                <span className="rounded-full bg-pale-teal px-3 py-1 text-xs font-medium text-navy">
                  User
                </span>
              </div>
            ...
            <div className="rounded-[20px] border border-border bg-card p-6 shadow-soft rounded-tl-md">
              ...
              <p className="mt-3 text-[15px] leading-relaxed text-foreground">
                Here's a simple option — the <strong>Greek Yogurt Power Bowl</strong>: Greek yogurt,
                berries, chia seeds and a small handful of nuts. Prep time: about 5 minutes. Want me
                to turn this into a grocery list?
              </p>
              <div className="mt-4 flex flex-wrap gap-2">
                {["Create Grocery List", "Give Me 3 More", "Save Recipe"].map((label) => (
                  <span
                    key={label}
                    className="rounded-[12px] bg-navy px-3 py-1.5 text-xs font-semibold text-white"
                  >
                    {label}
                  </span>
                ))}
              ...
              {[
                {
                  n: "01",
                  title: "Ask",
                  text: "Type any question about your wellness journey in the chat.",
                },
                {
                  n: "02",
                  title: "Learn",
                  text: "Get a clear, educational answer with practical steps.",
                },
                {
                  n: "03",
                  title: "Act",
                  text: "Save ideas, build grocery lists, and prep for your provider.",
                },
              ].map((step) => (
                <div
                  key={step.n}
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          ...
          <h2 className="font-display text-3xl font-bold tracking-tight text-navy">
            Built to reinforce your care plan.
          </h2>
          <p className="mt-3 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            FitSlim AI focuses on general wellness education that complements — never replaces — the
            guidance from your provider and care team.
          </p>
          <div className="mt-8 flex flex-col gap-5 sm:flex-row">
            <div className="flex-1 rounded-[20px] border border-border bg-card p-6 shadow-soft">
              ...
              <h3 className="font-display mt-3 text-lg font-bold text-navy">
                Pairing with your care team
              </h3>
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                FitSlim AI works alongside the FitSlim Method™ and your Blueprint™ to answer
                questions and reinforce healthy habits in between visits.
              </p>
            </div>
            <div className="flex-1 rounded-[20px] border border-border bg-card p-6 shadow-soft">
              <span className="grid size-12 place-items-center rounded-[16px] bg-light-blue">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                FitSlim AI provides educational support. It does not diagnose, treat, interpret
                labs, or prescribe medication.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          ...
          <h2 className="font-display text-3xl font-bold tracking-tight text-navy">
            General education to discuss with your provider.
          </h2>
          <AlertBanner tone="info" title="Medication decisions belong to your provider.">
            FitSlim AI shares general nutrition education to support your plan, but it cannot advise
            on medication, dosing or symptoms. Follow the guidance from your prescribing provider.
          </AlertBanner>
        </section>
          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              <div>
                ...
                <h2 className="font-display text-3xl font-bold tracking-tight text-navy">
                  Ready to talk with your provider?
                </h2>
                <p className="mt-3 text-lg leading-relaxed text-muted-foreground">
                  FitSlim AI helps you prep the questions you want to discuss, so you show up ready
                  to make the most of every visit.
                </p>
                <div className="mt-6 flex flex-wrap gap-2">
                  <AskAiButton label="Prepare Provider Questions" className="rounded-[14px]" />
                  <Button
                    variant="outline"
                    className="rounded-[14px] border-teal text-teal hover:bg-pale-teal"
                    asChild
                  >
        ...
        <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
          <h2 className="font-display text-3xl font-bold tracking-tight text-navy">
            A boundary we take seriously.
          </h2>
          <div className="mt-6">
            <AlertBanner tone="urgent" title="FitSlim AI is not an emergency service.">
              For urgent or emergency symptoms, seek appropriate medical care through your local
              resources. FitSlim AI never receives or responds to live health events.
            </AlertBanner>
          </div>
        </section>
        ...
        <section className="bg-navy py-16">
          <div className="mx-auto flex max-w-5xl flex-col items-center gap-5 px-4 text-center sm:px-6">
            <h2 className="font-display text-3xl font-bold tracking-tight text-white">
              Ready to see what FitSlim AI™ can do?
            </h2>
            <p className="max-w-2xl text-lg leading-relaxed text-pale-teal">
              FitSlim AI™ gives you practical educational support when real life happens — from meal
              planning and restaurant choices to hydration and questions for your care team.
            </p>
            <div className="flex flex-col gap-3 sm:flex-row">
              <Button
                ...
                asChild
              >
                <Link to="/home">TRY FITSLIM AI™</Link>
              </Button>
              <Button
